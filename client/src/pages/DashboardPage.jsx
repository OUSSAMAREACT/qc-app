                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                                <BookOpen className="text-blue-600 dark:text-blue-400" size={24} /> Modules de révision
                            </h2>
                        ...
                        {categories.length === 0 ? (
                            <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-2xl border border-dashed border-gray-300 dark:border-gray-700">
                                <p className="text-gray-500 dark:text-gray-400">Chargement des modules...</p>
                            </div>
                        ) : (
                                        ...
                                        <div className="p-6 flex-1 flex flex-col">
                                            ...
                                            <div className="mt-auto pt-4">
                                                <Link to={`/quiz?category=${encodeURIComponent(cat.name)}`}>
                                                    <Button className="w-full bg-gray-900 dark:bg-gray-700 hover:bg-blue-600 dark:hover:bg-blue-500 text-white transition-colors flex items-center justify-center gap-2 group-hover:shadow-lg group-hover:shadow-blue-500/20">
